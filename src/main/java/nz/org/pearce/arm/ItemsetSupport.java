...
public class ItemsetSupport {
  ...
  public static ItemsetSupport make(ArrayList<FrequentPattern> patterns, int numTransactions) {
  ...
  public double support(int[] items) {
    return map.get(Arrays.hashCode(items));
  }
